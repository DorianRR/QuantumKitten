...
public class MapGenScript_copy : MonoBehaviour {

    public Transform trans;
	public float TileDimension=4f;
	private bool ClusterMode=false;
    private GameObject[] prefabClusterBlue;
    private GameObject[] prefabClusterBlack;
    private GameObject[] prefabClusterWhite;
    private GameObject[] prefabClusterRed;
    private GameObject[] prefabClusterGreen;
